...
const KRIItem = ({ 
  ...
  return (
    <section className="hover:bg-slate-50 rounded-lg px-5">
        <div className="flex items-center justify-between py-3 cursor-pointer" onClick={handleClick}>
            <div className="flex items-start space-x-4 w-full md:w-1/2">
                <svg className='w-14 fill-white' viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="pt-3">
                        ...
                        {showAddkey && (
                            <Button type="text" className="p-4 mt-1 flex items-center space-x-2" onClick={(e) => handleRevealKIs(e)}>
                                <PlusCircleOutlined />
                                <span className='text-gray-500 font-semibold'>Add a new key result</span>
            ...
            {showTime && (
                <div className="p-2 bg-gray-200">
                    <div>{getQuater(target_date)} - {target_date ? new Date(new Date(target_date))?.getFullYear() : ''}</div>
            ...
            <div>
                <div className={`${approval_status ? 'visible' : 'invisible'} bg-danger text-white p-2 rounded-lg text-base capitalize`}>
