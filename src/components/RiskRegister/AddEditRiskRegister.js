  ...
  return (
    ...
    >
      <div className="mb-4 md:flex md:justify-between">
        ...
        <Form.Item
          className="mb-4 w-1/2 md:mb-0 pl-4"
          name="linked_kri"
          label={
            <span className="block mb-2 text-base font-bold text-gray-700">
              Linked KRI
      ...
      <div className="mb-4 md:flex md:justify-between">
        ...
        <Form.Item
          className="w-full sm:w-1/2 md:mb-0 pl-4 mb-4"
...
export default memo(AddEditRiskRegister);
