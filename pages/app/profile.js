    ...
    <AppLayout>
      <div className="w-full flex items-stretch py-5 px-8">
        <div className="w-full py-6 sm:w-2/3">
            ...
            <div className="mb-4 md:flex md:justify-between">
                <div className="w-1/2 sm:pr-4">
                    <label className="block mb-2 text-sm font-bold text-gray-700" for="Location">
                        Location
                    </label>
                    <input 
                    type="text" 
                ...
                <div className="w-1/2 sm:pl-4">
                    <label className="block mb-2 text-sm font-bold text-gray-700" for="timezones">
                        Time Zone
                    </label>
                    <input 
                    type="text" 
            ...
            <div className="mb-4 md:flex md:justify-between">
                <div className="w-1/2 sm:pr-4">
                    <label className="block mb-2 text-sm font-bold text-gray-700" for="Business Name">
                        Business Name
                    </label>
                    <input 
                    type="text" 
            ...
            <div className="mb-4 md:flex md:justify-between">
                <div className="w-1/2 sm:pr-4">
                    <label className="block mb-2 text-sm font-bold text-gray-700" for="department">
                        Department
                    </label>
                    <input 
                    type="text" 
        ...
        <div className="w-full sm:w-1/3 py-6 pl-4">
